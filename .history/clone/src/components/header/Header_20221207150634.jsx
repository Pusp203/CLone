  ...
  return (
    <div className="header-main">
      <div className="header-content">
        <h1 className="header-container__title">Build. Grow. Pivot.</h1>
        ...
        <div className="header-link__home">
          <a href="/#freeHome">
            <div className="header-link_label">FREE CONSULATION</div>
            <div className="header-links__button"></div>
          </a>
        </div>
        

        <div className="text-header">
          <p className="we-built">
      ...
      "
          ...
          <a href="" className="a-tag">
            <img src="	https://boostylabs.com/uploads/home-logos/1612964908953.svg" alt="Consensys" width="100" height="100" />
          </a>
          <a href="#" className="a-tag">
            <img src="https://boostylabs.com/uploads/home-logos/16106295628.svg" alt="storyj" width="100" height="100" />
          </a>
          <a href="#" className="a-tag">
            <img src="https://boostylabs.com/uploads/home-logos/1627727420295.svg" alt="nem" width="100" height="100" />
          </a>
          <a href="#" className="a-tag">
            <img src="https://boostylabs.com/uploads/home-logos/1612964908953.svg" alt="mysterium" width="100" height="100" />
          </a>
          <a href="#" className="a-tag">
