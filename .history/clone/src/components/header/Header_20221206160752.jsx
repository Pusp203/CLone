...
const Header = () => {
  return (
    ...
    <p className='header-content__text'>Unlock your company or startup`s hidden growth potential with us, <br/>
    using Blockchain, Fintech or the Cloud. IT outsourcing company. <br/>
     Boosty Labs helps you create an innovative end to end product or <br/>
     augment your team with the right experts.</p>
      
    <div className='header-link-home'>
    <a href='/#freeHome'>
    <div className='header-link_label'>FREE CONSULATION
    </div>
    <div className='header-link_button'></div>
      ...
      <a href='#'>
      <img src='https://boostylabs.com/uploads/home-logos/1653635221739.svg
      ' alt='Ledger' width='100' height='100'/>
      </a>
      <a href='https://boostylabs.com/img/cases/case-4/case-4-1.svg'>
      <img src='' alt='Consensys' width='100' height='100'/>
      </a>
      <a href='#'>
      <img src='' alt='storyj' width='100' height='100'/>
      </a>
      <a href='#'>
      ...
      <div className='about-container__part_description' >Five years ago, Viktor Ihnatiuk’s peer to peer lending company was acquired. He was 21 years old. Later, the young fintech veteran built a product development outsourcing team of industry experts to tackle a number of projects including ones in <a href='https://google.com'>fintech</a>, <a href='https://boostylabs.com/blockchain'> blockchain</a> <br/> and cloud storage.</div>
    
      <div>Attracted by our ability to create products, several market leading companies became our clients. Together we developed cutting-edge digital solutions which addressed customers' dilemmas and helped to improve their business</div>
    ...
    <img src='https://boostylabs.com/img/McKinsey&Company.svg' className='about-container__img' width='200' height='50' alt='McKinsey and COmpany'/> <br/>
    <img src='https://boostylabs.com/img/samsung.svg
    ' className='about-container__img' width='200' height='50' alt='SAMSUNG'/> <br/>
    <img src='https://boostylabs.com/img/vodafone.svg
    ' className='about-container__img' width='200' height='50' alt='vodafone'/> <br/>
