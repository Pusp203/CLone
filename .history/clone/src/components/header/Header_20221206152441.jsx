...
const Header = () => {
  return (
    ...
    <div className='header-link_button'></div>
      ...
      <div className='about-container__part_description' >Five years ago, Viktor Ihnatiuk’s peer to peer lending company was acquired. He was 21 years old. Later, the young fintech veteran built a product development outsourcing team of industry experts to tackle a number of projects including ones in" <a href='https://google.com'>fintech</a> " , " <a href='https://boostylabs.com/blockchain'> blockchain</a>"  <brblockchain and cloud storage.</div>
