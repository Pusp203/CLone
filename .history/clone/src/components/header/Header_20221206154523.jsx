...
const Header = () => {
  return (
    <div className=''>
    <h1 className='header-content'>Build. Grow. Pivot.</h1>
    <p className='header-content' header-content>Unlock your company or startup`s hidden growth potential with us, using Blockchain, Fintech or the Cloud. IT outsourcing company Boosty Labs helps you create an innovative end to end product or augment your team with the right experts.</p>
