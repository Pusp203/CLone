  ...
  return (
    <div className="">
      ...
      "
          ...
          <a href="https://boostylabs.com/cases/consensys>
            <img src="https://boostylabs.com/img/cases/case-4/case-4-1.svg" alt="Consensys" width="100" height="100" />
          </a>
          <a href="#">
            <img src={image1} alt="storyj" width="100" height="100" />
          </a>
          <a href="#">
            <img src={asset2} alt="nem" width="100" height="100" />
          </a>
          <a href="#">
            <img src={asset3} alt="mysterium" width="100" height="100" />
          </a>
          <a href="#">
            <img src="https://boostylabs.com/uploads/home-logos/161062975515.svg" alt="Celcius" width="100" height="100" />
          </a>
          <a href="#">
