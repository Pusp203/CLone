...
const Brand = () => {
  return (
    ...
    <section className='about-text'>Who we are</section>
      <div className='about-container__part_description' >Five years ago, Viktor Ihnatiuk’s peer to peer lending company was acquired. He was 21 years old. Later, the young fintech veteran
      <br/>built a product development outsourcing team of industry experts to tackle a number of projects including ones in <a href='https://google.com'>fintech</a>, <a href='https://boostylabs.com/blockchain'> blockchain</a> and cloud storage.</div>
