...
const Brand = () => {
  return (
    ...
    <section className='about-text'>Who we are</section>
      ...
      <div className='brand-'>Attracted by our ability to create products, several market leading companies became our clients. Together we developed cutting-edge digital solutions which addressed customers' dilemmas and helped to improve their business</div>
